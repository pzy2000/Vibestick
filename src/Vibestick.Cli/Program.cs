...
internal static class Program
{
    ...
    private static async Task<int> RunCoderEmitAsync(string[] args, Services services, bool json)
    {
        ...
        {
            Console.Error.WriteLine("Missing or invalid --phase. Expected: idle, sleeping, running, reasoning, tool_calling, waiting_authorization, error, success, offline, unknown.");
            return 1;
        }
