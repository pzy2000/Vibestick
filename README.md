...
When no adapter state exists, Vibestick falls back to whitelisted process detection for tools such as Codex, Claude Code, OpenCode, OpenClaw, Hermes, Nanobot, Docker, and similar long-running coder tasks.
